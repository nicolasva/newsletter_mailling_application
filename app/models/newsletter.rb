class Newsletter < ActiveRecord::Base
	...
	attr_accessible :name, :mailadd, :content, :subcontact_ids, :email_ids, :mailstart_id, :categoryall_id, :date_specification, :created_on, :created_at, :timeractivate, :newslettertimingprogrammings_attributes
	...
	accepts_nested_attributes_for :newslettertimingprogrammings
